...
<html lang="en">
	<head>
        ...
        <script src="${ctx}/static/js/jquery.nicescroll.js" type="text/javascript"></script>
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" name="${ctx}/product/findAll.action"  title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
           ...
           $("#menu_style").niceScroll({  
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
                 ...
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="${ctx}/index/home.action">  </iframe>
